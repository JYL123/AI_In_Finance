...
(function (global, factory) {
  ...
  }var version$1 = "0.7.1";function preprocessWeightsForLoading(e, t, n, r) {
    ...
    function t(t) {
      ...
      var n = this;return tidy(function () {
        if (2 !== (e = e).length) throw new ValueError("GRUCell expects 2 input Tensors (inputs, h, c), got " + e.length + ".");var r = null != t.training && t.training,
          ...
          0 < n.dropout && n.dropout < 1 && (e = mul(e, l[0]));var k = dot$1(e, n.kernel.read());n.useBias && (k = biasAdd(k, n.bias.read())), 0 < n.dropout && n.dropout < 1 && (i = mul(i, u[0]));var C = dot$1(i, sliceAlongLastAxis(n.recurrentKernel.read(), 0, 2 * n.units)),
              L = (b = sliceAlongLastAxis(k, 0, n.units), z = sliceAlongLastAxis(k, n.units, n.units), sliceAlongLastAxis(C, 0, n.units)),
              x = sliceAlongLastAxis(C, n.units, n.units);a = n.recurrentActivation.apply(add(b, L)), o = n.recurrentActivation.apply(add(z, x));w = sliceAlongLastAxis(k, 2 * n.units, n.units);var T = dot$1(mul(o, i), sliceAlongLastAxis(n.recurrentKernel.read(), 2 * n.units, n.units));s = n.activation.apply(add(w, T));
  ...
  var __assign$2 = Object.assign || function (e) {
    ...
    !function (a) {
      var r = t && !t.nodeType && t,
          n = e && !e.nodeType && e,
          o = "object" == typeof commonjsGlobal$1 && commonjsGlobal$1;o.global !== o && o.window !== o && o.self !== o || (a = o);var s,
          i,
          p = 2147483647,
          u = 36,
          l = 1,
    ...
    return __awaiter$2(this, void 0, void 0, function () {
      var r, n, o, s, i, p, u, l, m, d, f, c, h, y, g, N, P, b, x, v, I, O, w, V, k, T, $, _, A, S, D, C, E, j, R;return __generator$2(this, function (L) {
        switch (L.label) {case 0:
            ...
            return S = getParamValue("tensorArrayId", e, t, a), D = getParamValue("tensor", e, t, a), C = getParamValue("lengths", e, t, a), a.getTensorArray(S).split(C, D), [2, [scalar(1)]];case 15:
            return E = getParamValue("tensorArrayId", e, t, a), j = a.getTensorArray(E), [2, [scalar(j.size(), "int32")]];case 16:
    ...
    switch (e.op) {case "fill":
        ...
        var o = getParamValue("start", e, t, a),
            ...
            i = getParamValue("num", e, t, a);return [linspace(o, s, i)];case "oneHot":
    ...
    switch (e.op) {case "concat":
        ...
        i = getParamValue("begin", e, t, a);var u = getParamValue("end", e, t, a),
            ...
            f = getParamValue("x", e, t, a);if (1 === i.length && f.shape.length > 1) for (var c = 1; c < f.shape.length; c++) i.push(0), u.push(f.shape[c]), l.push(l[0]);return [stridedSlice(f, i, u, l, m, d)];case "stack":
        return tidy(function () {
          var r = getParamValue("axis", e, t, a),
        ...
        var h = getParamValue("reps", e, t, a);return [tile(getParamValue("x", e, t, a), h)];case "split":
        r = getParamValue("axis", e, t, a);var y = getParamValue("numOrSizeSplits", e, t, a);return split(getParamValue("x", e, t, a), y, r);default:
        throw TypeError("Node type " + e.op + " is not implemented");}
  },
    ...
    function e(e) {
      ...
      return __awaiter$2(this, void 0, void 0, function () {
        var a,
            ...
            i,
            p,
            u = this;return __generator$2(this, function (l) {
          switch (l.label) {case 0:
      ...
      return __awaiter$2(this, void 0, void 0, function () {
        var a, r, n, o, s, i, p, u;return __generator$2(this, function (l) {
          switch (l.label) {case 0:
